...
def load_syn(base_path):
    ...
    syn_train_data = loadmat(path.join(base_path, "dataset", "DigitFive", "svhn_train_32x32.mat"))
    print("load syn test")
    syn_test_data = loadmat(path.join(base_path, "dataset", "DigitFive", "svhn_test_32x32.mat"))
