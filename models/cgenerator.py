...
#         elif args['data_set'] in ['SVHN', 'CIFAR-10', 'CIFAR-100']:
#             data_shape = [3, 32, 32]
#             if args['data_set'] in ['SVHN', 'CIFAR-10']:
#                 self.classes_size = 10
...
#             data_shape = [1, 28, 28]
#             self.classes_size = 10
#         elif args['data_set'] in ['CIFAR-10', 'CIFAR-100', 'SVHN']:
#             data_shape = [3, 32, 32]
#             if args['data_set'] in ['CIFAR-10', 'SVHN']:
#                 self.classes_size = 10
#             elif args['data_set'] == 'CIFAR-100':
#                 self.classes_size = 100
#         elif args['data_set'] in ['Tiny-Imagenet']:
...
class Generator_ACGan(nn.Module):
    ...
    def __init__(self, args):
        ...
        self.latent_dim = 64
        self.noise_label_combine = 'mul'
        if self.data_set in ['cifar10', 'FMNIST', 'MNIST', 'SVHN']:
            self.n_classes = 10
